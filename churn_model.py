...
class ChurnPredictor:
    ...
    def get_top_churn_risks(self, df, top_n=10):
        ...
        top_risks = predictions.nlargest(top_n, 'churn_probability')[
            ['customer_id', 'age', 'gender', 'country', 'churn_probability', 'churn_risk',
...
if __name__ == "__main__":
    # Sample data (you'll replace this with your actual data loading)
    sample_data = pd.read_csv('data/customer_data.csv')  # Your CSV file path
